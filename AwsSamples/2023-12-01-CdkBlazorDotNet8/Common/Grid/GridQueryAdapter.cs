        ...
        {
            {
                ...
                cs => cs.Where(c =>
                    c != null && c.City != null && _controls.FilterText != null && c.City.Contains(_controls.FilterText))
            },
            {
                ContactFilterColumns.Phone,
                cs => cs.Where(c =>
                    c != null && c.Phone != null && _controls.FilterText != null && c.Phone.Contains(_controls.FilterText))
            },
            {
                ContactFilterColumns.Name,
                cs => cs.Where(c =>
                    c != null && c.FirstName != null && _controls.FilterText != null && c.FirstName.Contains(_controls.FilterText))
            },
            {
                ContactFilterColumns.State,
                cs => cs.Where(c =>
                    c != null && c.State != null && _controls.FilterText != null && c.State.Contains(_controls.FilterText))
            },
            {
                ContactFilterColumns.Street,
                cs => cs.Where(c =>
                    c != null && c.Street != null && _controls.FilterText != null && c.Street.Contains(_controls.FilterText))
            },
            {
                ContactFilterColumns.ZipCode,
                cs => cs.Where(c =>
                    c != null && c.ZipCode != null && _controls.FilterText != null && c.ZipCode.Contains(_controls.FilterText))
            }
        };
    }
