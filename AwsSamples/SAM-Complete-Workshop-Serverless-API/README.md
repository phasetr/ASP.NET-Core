...
- `ASP.NET Core`と`DynamoDB Local`との接続方法：[参考](https://docs.aws.amazon.com/ja_jp/amazondynamodb/latest/developerguide/CodeSamples.DotNet.html#CodeSamples.DotNet.RegionAndEndpoint)
