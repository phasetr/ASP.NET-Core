...
- [Apply JWT Access Tokens and Refresh Tokens in ASP.NET Core Web API](https://codingsonata.com/apply-jwt-access-tokens-and-refresh-tokens-in-asp-net-core-web-api/)
  - cf. [GitHub](https://github.com/aram87/TasksApi)
